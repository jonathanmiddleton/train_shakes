...
wandb_log = False # optional W&B logging
...
while True:
    ...
    if iter_num % log_interval == 0:
        ...
        if wandb_log: wandb.log({ "step": iter_num, "train/loss": lossf, "lr": lr, "tokens": iter_num * batch_size * gradient_accumulation_steps, })
    iter_num += 1
